...
final class PaymentElementConfig implements ConfigInterface, SessionComponentInterface
{
    ...
    public function setFeaturePaymentMethodRedisplayEnabled(bool $enabled): PaymentElementConfig
    {
    ...
    public function setFeaturePaymentMethodRemoveEnabled(bool $enabled): PaymentElementConfig
    {
    ...
    public function setFeaturePaymentMethodSaveEnabled(bool $enabled): PaymentElementConfig
    {
    ...
    public function setFeaturePaymentMethodSaveUsageEnabled(bool $enabled): PaymentElementConfig
    {
    ...
    public function setEnabled(bool $enabled): PaymentElementConfig
    {
